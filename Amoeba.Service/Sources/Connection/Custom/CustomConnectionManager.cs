...
namespace Amoeba.Service
{
    ...
    {
        sealed class CustomConnectionManager : StateManagerBase, ISettings
        {
            ...
            private AtomicInteger _blockCount = new AtomicInteger();

            private readonly object _lockObject = new object();
            private volatile bool _isDisposed;

            public CustomConnectionManager(string configPath, CatharsisManager catharsisManager, BufferManager bufferManager)
            {
