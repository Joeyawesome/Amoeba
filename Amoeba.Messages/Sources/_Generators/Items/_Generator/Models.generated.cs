...
namespace Amoeba.Messages
{
    ...
    [JsonObject(MemberSerialization = MemberSerialization.OptIn)]
    public sealed partial class NetworkConnectionReport : ItemBase<NetworkConnectionReport>
    {
        [JsonConstructor]
        ...
        public override bool Equals(NetworkConnectionReport target)
        {
            if ((object)target == null) return false;
            if (Object.ReferenceEquals(this, target)) return true;
        ...
        public override int GetHashCode()
        {
            if (!_hashCode.HasValue)
            {
                ...
                if (this.Type != default(SessionType)) h ^= this.Type.GetHashCode();
    ...
    public sealed partial class NetworkConfig : ItemBase<NetworkConfig>
    {
        ...
        [JsonProperty]
        public int BandwidthLimit { get; }
        public override bool Equals(NetworkConfig target)
        {
            if ((object)target == null) return false;
            if (Object.ReferenceEquals(this, target)) return true;
            if (this.ConnectionCountLimit != target.ConnectionCountLimit) return false;
            if (this.BandwidthLimit != target.BandwidthLimit) return false;
            return true;
        }
        private int? _hashCode;
        public override int GetHashCode()
        {
            ...
            {
                int h = 0;
                if (this.ConnectionCountLimit != default(int)) h ^= this.ConnectionCountLimit.GetHashCode();
                if (this.BandwidthLimit != default(int)) h ^= this.BandwidthLimit.GetHashCode();
                _hashCode = h;
            }
            return _hashCode.Value;
        }
    ...
    public sealed partial class DownloadConfig : ItemBase<DownloadConfig>
    {
        ...
        [JsonProperty]
        public int ProtectedPercentage { get; }
        public override bool Equals(DownloadConfig target)
        {
            if ((object)target == null) return false;
            if (Object.ReferenceEquals(this, target)) return true;
            if (this.BasePath != target.BasePath) return false;
            if (this.ProtectedPercentage != target.ProtectedPercentage) return false;
            return true;
        }
        private int? _hashCode;
        public override int GetHashCode()
        {
            if (!_hashCode.HasValue)
            {
                ...
                if (this.ProtectedPercentage != default(int)) h ^= this.ProtectedPercentage.GetHashCode();
                _hashCode = h;
            }
            return _hashCode.Value;
        }
